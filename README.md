...
The ground station was written in and tested with Matlab 2016a. All functions have help text defined. Type 'help <function name>' or 'doc <function name>' into the matlab command line to view it.
